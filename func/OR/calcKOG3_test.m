function [ang, upairs, dis1, udis1, pair_ind] = calcKOG3_test (orname,varargin)
% calcucate KOG
%
%% Description
...
%% Syntax
%  ang = calcKOG(orname) -
%  ang = calcKOG(orname,'display') -
%
%% Input
%  orname	- name of orientation relation
%    currently available:
%
%    * 'KS' - Kurdjumov-Sachs
%    * 'K' - Kelly
...
% end
% 
% plot([ORoa*vector3d(1,0,0) ORoa*vector3d(0,1,0) ORoa*vector3d(0,0,1)],'label', [V V V], 'antipodal', 'MarkerSize',6);
% return;
...
% % % ORo = orientation('matrix', OR, CS, SS);
% % ORo = orientation('matrix', OR, SS, CS);
