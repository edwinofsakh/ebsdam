function [ ebsd ] = b03_load( varargin )
%b01_load Load EBSD data from 'Zolot_beinit\19.txt'
%  Supplier : Prometey
...
%  Step     : ??? x ??? nm
%  Comments :
%   Ingnore phase. For more details see file ".\Zolot_beinit\19.doc"

%% Settings

% File name
fname = '.\Zolot_beinit\19.txt';
