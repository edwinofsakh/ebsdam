function [ ebsd ] = af06vs_load( varargin )
%Load EBSD data from 'Austenite_frag\6_very small area\6_very small area.ang'
%  Supplier : Prometey
...
%  Step     : ??? x ??? nm
%  Comments :
%   Ingnore phase. For more details see file ".\Austenite_frag\6.doc"

%% Settings

% File name
fname = '.\Austenite_frag\6_very small area\6_very small area.ang';
