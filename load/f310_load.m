function [ ebsd ] = f310_load( varargin )
...
% File name
fname = '.\FTIM\3-10-500-1.txt';

% Specify crystal and specimen symmetry
cs = {...
  symmetry('m-3m','mineral','Fe'),... % crystal symmetry phase cementite
  symmetry('m-3m','mineral','Cm'),... % crystal symmetry phase ferrite
